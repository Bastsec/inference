...
ALTER TABLE "activity_logs" ADD CONSTRAINT "activity_logs_user_uuid_profiles_id_fk" FOREIGN KEY ("user_uuid") REFERENCES "public"."profiles"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "team_members" ADD CONSTRAINT "team_members_user_uuid_profiles_id_fk" FOREIGN KEY ("user_uuid") REFERENCES "public"."profiles"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "virtual_keys" ADD CONSTRAINT "virtual_keys_user_id_profiles_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."profiles"("id") ON DELETE cascade ON UPDATE no action;